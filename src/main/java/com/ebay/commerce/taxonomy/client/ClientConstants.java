...
public class ClientConstants {
    private static Map<Environment,String>  END_POINTS = new HashMap() {
        {
            put(Environment.PRODUCTION,"https://api.ebay.com/commerce/taxonomy/v1_beta/category_tree/%s/fetch_item_aspects");
            put(Environment.SANDBOX,"https://api.sandbox.ebay.com/commerce/taxonomy/v1_beta/category_tree/%s/fetch_item_aspects");
        }
    };
